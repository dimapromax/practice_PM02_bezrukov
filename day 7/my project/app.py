...
app = Flask(__name__)
app.secret_key = 'ваш_секретный_ключ_замените_на_случайный'  # В реальном проекте хранить в .env

# Настройки MySQL
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'root'
app.config['MYSQL_PASSWORD'] = 'dimabdn2008BEZR'  # Ваш пароль от MySQL
app.config['MYSQL_DB'] = 'biblioteka'  # Имя вашей БД
